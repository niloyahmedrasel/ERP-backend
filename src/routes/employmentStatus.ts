...
router.post("/",authenticateToken, validate(employmentStatusSchema), new EmploymentStatusController().createEmploymentStatus);
...
router.put("/:id",authenticateToken, validate(employmentStatusSchema), new EmploymentStatusController().updateEmploymentStatus);
