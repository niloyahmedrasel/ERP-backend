...
router.post("/create",authenticateToken, validate(salaryComponentValidationSchema), new SalaryComponentController().createSalaryComponent);
...
router.put("/update/:id",authenticateToken, validate(salaryComponentValidationSchema), new SalaryComponentController().updateSalaryComponent);
