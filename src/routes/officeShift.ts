...
router.post("/create",authenticateToken, validate(officeShiftSchema), new OfficeShiftController().createOfficeShift);
...
router.put("/update/:id",authenticateToken, validate(officeShiftSchema), new OfficeShiftController().updateOfficeShift);
